...
////////////////////////////////////Collision codes are here////////////////////////////////////////////////
	...
	if(!level3_monstercol){
		...
		iText(160,550,"Press 'x' or the cross button to exit",GLUT_BITMAP_HELVETICA_18);
		iText(560, 560, "Shoot on the head 4 times to kill the monster fast", GLUT_BITMAP_HELVETICA_18);;
		iSetColor(255, 255, 255);
		highScoreFunction();
		highScoreCalculation();
...
int main()
{
	...
	selectlevel = iLoadImage("images\\selectlevelpage-972x583.bmp");
