void level1_collide()
{
	...
	{
	if((level1_monspow_posy >= level1_cartoon_posy+level1_playerCordinateJump-130) && (level1_monspow_posy <= level1_cartoon_posy+level1_playerCordinateJump+150))
	{
		level1_lives--;
		if(level1_lives == 0)
		{
		...
		//iShowImage(0, 0, 583, 972, gameOver);
		//cartoon_posx=5888;
		//cartoon_posy=5565;
		//monspow_posx = 10000;
		//iceball_posx = -10000;
...
void level3_collide()
{
	...
	{
	if((level3_monspow_posy >= level3_cartoon_posy+level3_playerCordinateJump-170) && (level3_monspow_posy <= level3_cartoon_posy+level3_playerCordinateJump+200))
	{
		level3_lives--;
		if(level3_lives == 0)
		{
